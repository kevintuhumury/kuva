...
# retrieve an Access Token and Access Token secret. These will
# enable Kuva to make authorized requests to the Flickr API.
Kuva.setup do |config|
  ...
  # Token secret can be retrieved by using the kuva:authorize Rake
  # task. Once you've done that, enable this configuration option
  # and set it's value.
